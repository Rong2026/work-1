...
class GRPOConfig(TrainingArguments):
    ...
    dynamic_sampling: Optional[bool] = field(
        default=False
    )
    difficulty_adjust: Optional[bool] = field(
        default=False
    )
    single_img_with_cot: Optional[bool] = field(
        default=True
    )
    # Parameters for dynamic reward weight adjustment based on IoU performance
    dynamic_reward_weights: Optional[bool] = field(
        default=False,
        metadata={
            "help": "Whether to enable dynamic reward weight adjustment based on IoU performance. "
            "When enabled, center_area_reward weight is higher when IoU is low, and iou_reward weight is higher when IoU is high."
        },
    )
