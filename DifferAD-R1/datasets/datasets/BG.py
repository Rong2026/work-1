        ...
        for data_name in self.dataset_name:
            ...
            if os.path.isdir(neg_dir):
                ...
                for img_path in neg_imgs:
                    ...
                    save_img_path = os.path.join(dst_train_good, f"BG_f{tail3}_{str(id).zfill(6)}.png")
            ...
            if os.path.isdir(pos_dir):
                ...
                for img_path in pos_imgs:
                    ...
                    save_img_path = os.path.join(dst_test_anom, f"BG_anomaly_f{tail3}_{str(id).zfill(6)}.png")
                    save_mask_path = os.path.join(dst_gt_anom, f"BG_anomaly_f{tail3}_{str(id).zfill(6)}.png")
                    cv2.imwrite(save_img_path, raw_img)
